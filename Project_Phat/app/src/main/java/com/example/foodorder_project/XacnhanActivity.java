...
public class XacnhanActivity extends AppCompatActivity {
    ...
    TextView btnHuydon, btnlienhe;
    TextView tongtien, thanhtien, soluong, ngaydat;

    @SuppressLint("MissingInflatedId")
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.chitietdonhang_choxacnhan);
...
//        listfood.add(new Xacnhan(R.drawable.ic_comchienraucu, "Cơm chiên rau củ", "Size M", "1", "70.000đ"));
        ...
        btnHuydon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent4 = new Intent(XacnhanActivity.this, Xacnhan_HuyDon_Activity.class);
                intent4.putExtra("quantity1", finalQuantity);
                intent4.putExtra("price1", finalPrice);
        ...
        btnlienhe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent5 = new Intent(XacnhanActivity.this, trangthaichatshipper_nhahangActivity.class);
...
//        thanhtien.setText(String.valueOf(Integer.parseInt(price) + 10000));
        thanhtien.setText("230000");
    }
}
